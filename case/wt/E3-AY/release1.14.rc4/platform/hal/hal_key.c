...
//common key define
#define KEY_LONGLONGPRESS_THRESHOLD_MS  (MS_TO_TICKS((1500)))
#define KEY_LONGPRESS_THRESHOLD_MS  (MS_TO_TICKS((1500)))
...
#define KEY_INIT_LONGPRESS_THRESHOLD_MS  (MS_TO_TICKS((3000)))
#define KEY_INIT_LONGLONGPRESS_THRESHOLD_MS  (MS_TO_TICKS((10000)))
...
static int (*key_detected_callback)(uint8_t, uint8_t) = NULL;
